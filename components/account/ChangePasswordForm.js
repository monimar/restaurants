...
export default function ChangePasswordForm({ setShowModal, toastRef}) {
    ...
    const onSubmit = async() => {
        ...
        if (!resultUpdatePassword.statusResponse) {
            setErrorNewPassword("Se presentó un problema cambiando la contraseña, por favor intente más tarde")
            return
        }
    ...
    const validateForm = () => {
        ...
        if( newPassword === currentPassword) {
            setErrorCurrentPassword  ("Debes ingresar una contraseña igual a la actual.")
            setErrorNewPassword ("Debes ingresar una contraseña igual a la actual.")
            setErrorConfirmPassword ("Debes ingresar una contraseña igual a la actual.")
            isValid = false
        }
